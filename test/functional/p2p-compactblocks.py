...
# TestNode: A peer we use to send messages to carrotd, and store responses.
...
class CompactBlocksTest(CarrotTestFramework):
    ...
    # This test actually causes carrotd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that carrotd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for carrotd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # carrotd will not send blocktxn responses for blocks whose height is
