...
By default, carrotd will dump mempool on shutdown and
...
class MempoolPersistTest(CarrotTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give carrotd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent carrotd from writing mempool.dat to disk. Verify that `savemempool` fails")
