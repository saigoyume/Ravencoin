...
from test_framework.test_framework import CarrotTestFramework, SkipTest
...
class ZMQTest (CarrotTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that carrot has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("carrotd has not been built with zmq enabled.")
