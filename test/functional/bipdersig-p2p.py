...
class BIP66Test(CarrotTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # carrotd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and carrotd produces more specific reject
            # reasons.
