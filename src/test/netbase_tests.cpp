...
{
    BOOST_CHECK(TestSplitHost("www.carrot.org", "www.carrot.org", -1));
    BOOST_CHECK(TestSplitHost("[www.carrot.org]", "www.carrot.org", -1));
    BOOST_CHECK(TestSplitHost("www.carrot.org:80", "www.carrot.org", 80));
    BOOST_CHECK(TestSplitHost("[www.carrot.org]:80", "www.carrot.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:31680", "127.0.0.1", 31680));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:31680", "127.0.0.1", 31680));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:31680", "::ffff:127.0.0.1", 31680));
    BOOST_CHECK(TestSplitHost("[::]:31680", "::", 31680));
    BOOST_CHECK(TestSplitHost("::31680", "::31680", -1));
    BOOST_CHECK(TestSplitHost(":31680", "", 31680));
    BOOST_CHECK(TestSplitHost("[]:31680", "", 31680));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:31680", "127.0.0.1:31680"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:31680", "[::]:31680"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
