...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CarrotAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_carrot-qt -platform xcb      # Linux
//     src/qt/test/test_carrot-qt -platform windows  # Windows
//     src/qt/test/test_carrot-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CarrotUnits::formatWithUnit(unit, balance, false, CarrotUnits::separatorAlways);
    ...
    // Amount input
    CarrotAmountField* amountInput = receiveCoinsDialog.findChild<CarrotAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: carrot:")) != -1);
