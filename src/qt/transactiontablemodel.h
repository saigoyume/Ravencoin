...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, CarrotUnits::SeparatorStyle separators=CarrotUnits::separatorStandard) const;
