...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCarrotURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CarrotUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCarrotURI(info));
}
